...
<head>
    ...
    <title>Consultorio Nutricional | Gestión Integral</title>
...
<body>
    <header class="header">
        <div class="header-content">
            <h1><i class="fas fa-heartbeat"></i> Consultorio Nutricional</h1>
            <p>Evaluación integral • Control de salud • Orientación personalizada</p>
        </div>
    </header>
